...
class ContextManager(ConversationMemory):
    ...
    estimated context exceeds *max_context_tokens*, old messages are replaced
    by a compact summary so the context window stays within budget.
    ...
    Args:
        ...
        summarizer: Callable that receives a list of Messages and returns a
            summary string.  If omitted, excess messages are simply dropped.
        keep_recent: Number of recent messages always preserved intact around
